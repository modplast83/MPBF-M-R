  ...
  try {
    ...
    const modules = [
      ...
      },
      {
        ...
        category: "production",
        route: "/production/workflow",
        icon: "GitBranch",
      },
      {
        name: "Mix Materials",
        displayName: "Mix Materials",
        category: "production",
        route: "/production/mix-materials",
        icon: "Beaker",
      },
      {
        name: "Bottleneck Monitor",
        displayName: "Bottleneck Monitor",
        category: "production",
        route: "/production/bottleneck",
        icon: "AlertTriangle",
      },
      {
      ...
      },
      {
        ...
        category: "warehouse",
        route: "/warehouse/final-products",
        icon: "PackageCheck",
      },
      ...
      // Quality modules
      {
        ...
        category: "quality",
        route: "/quality/unified-dashboard",
        icon: "Shield",
      },
      ...
      },
      {
        ...
        category: "hr",
        route: "/hr/employee-of-month",
        icon: "Award",
      },
      {
        name: "Violation and Complaint",
        displayName: "Violations & Complaints",
        category: "hr",
        route: "/hr/violations",
        icon: "AlertCircle",
      },
      ...
      },
      {
        ...
        displayName: "Maintenance Actions",
        category: "maintenance",
      ...
      // Tools modules
      {
        name: "Bag Weight Calculator",
        displayName: "Bag Weight Calculator",
        category: "tools",
        route: "/tools/bag-weight",
        icon: "Calculator",
      },
      {
        name: "Ink Consumption",
        displayName: "Ink Consumption",
        category: "tools",
        route: "/tools/ink-consumption",
        icon: "Droplets",
      },
      {
        name: "Mix Colors",
        displayName: "Mix Colors",
        category: "tools",
        route: "/tools/mix-colors",
        icon: "Palette",
      },
      {
        name: "Utility Tools",
    ...
    console.log(
      `Found ${sections.length} sections and ${modulesMap.length} modules`,
    );
    ...
    for (const section of sections) {
      for (const module of modulesMap) {
        ...
        const isAdminSection =
          section.name.toLowerCase().includes("admin") ||
