    ...
    async (req: Request, res: Response) => {
      try {
        ...
        if (success) {
          ...
          res
            .status(404)
            .json({ message: "Notification not found or not accessible" });
        }
      } catch (error) {
  ...
  app.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const validatedData = insertNotificationSchema
          .omit({ userId: true })
  ...
  app.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const template =
          await notificationService.createTemplate(validatedData);
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const validatedData = insertNotificationTemplateSchema
          .partial()
          .parse(req.body);
        const success = await notificationService.updateTemplate(
          templateId,
          validatedData,
        );
  ...
  app.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        res
          .status(500)
          .json({ message: "Failed to generate system notifications" });
      }
    },
  );
}
