...
export const templateDefinitions = {
  categories: {
    ...
    sampleData: [["CAT001", "Sample Category", "SC"]],
    fileName: "categories_template.csv",
  },
  customers: {
    headers: ["id", "code", "name", "nameAr", "userId", "plateDrawerCode"],
    sampleData: [["CUST001", "CUS1", "Sample Customer", "", "", "A-01"]],
    fileName: "customers_template.csv",
  },
  items: {
    headers: ["id", "categoryId", "name", "fullName"],
    sampleData: [["ITM001", "CAT001", "Sample Item", "Sample Full Item Name"]],
