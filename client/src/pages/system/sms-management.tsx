    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Send an SMS message to a specific phone number with customizable
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button
              onClick={sendMessage}
              disabled={!formData.recipientPhone || !formData.message}
            >
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            {template
              ? "Modify an existing SMS template"
              : "Create a new reusable SMS template"}{" "}
            for automated messaging.
          </DialogDescription>
        </DialogHeader>
        <div className="p-4 text-center text-gray-500">
          Template management functionality would be implemented here with form
          fields for template creation and editing.
        </div>
        <div className="flex justify-end gap-2">
          <Button variant="outline" onClick={() => setOpen(false)}>
            Cancel
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            {rule ? "Edit" : "Create"} Notification Rule
          </DialogTitle>
          <DialogDescription>
            {rule
              ? "Modify notification rule settings"
              : "Configure automated SMS notification triggers"}{" "}
            for system events.
          </DialogDescription>
        </DialogHeader>
        <div className="p-4 text-center text-gray-500">
          Notification rule management functionality would be implemented here
          with form fields for rule configuration.
        </div>
        <div className="flex justify-end gap-2">
          <Button variant="outline" onClick={() => setOpen(false)}>
            Cancel
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            View detailed information about this SMS message including delivery
            status and content.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
...
const SmsAnalytics = ({ messages }: { messages: SmsMessage[] }) => {
  ...
  const deliveryRate =
    totalMessages > 0
      ? ((deliveredCount / totalMessages) * 100).toFixed(1)
      : "0";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">
          Overview of SMS messaging performance
        </p>
      </div>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">
            Professional notifications and order tracking system
          </p>
        </div>
      </div>
      ...
      >
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex flex-col gap-1">
                        <Badge
                          variant={getStatusBadge(message.status)}
                          className="text-xs"
                        >
                          {message.status}
                        </Badge>
                        <Badge
                          variant={getPriorityBadge(message.priority)}
                          className="text-xs"
                        >
                          {message.priority}
                        </Badge>
                    ...
                    <div className="flex gap-1">
                      ...
                      {message.status === "failed" && (
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            resendMessageMutation.mutate(message.id)
                          }
        ...
        <TabsContent value="rules" className="space-y-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Automated notification triggers and conditions
              </p>
            </div>
                  ...
                  <CardHeader>
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <CardDescription>
                          Trigger: {rule.triggerEvent} • Priority:{" "}
                          {rule.priority}
                        </CardDescription>
                      </div>
                      <div className="flex gap-2">
        ...
        <TabsContent value="tracking" className="space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Monitor SMS notifications for orders
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {orders.slice(0, 12).map((order) => {
              const orderMessages = smsMessages.filter(
                (msg) => msg.orderId === order.id,
              );
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <span className="font-medium text-red-600">
                          {
                            orderMessages.filter((m) => m.status === "failed")
                              .length
                          }
                        </span>
                      </div>
