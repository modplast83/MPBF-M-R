...
export default function Permissions() {
  ...
  const handleCreatePermission = () => {
    ...
    const exists = permissions.some(
      (p) =>
        p.role.toLowerCase() === newRoleName.toLowerCase() &&
          ...
          <div className="bg-secondary-50 p-3 rounded-t-md border border-secondary-200">
            <h3 className="text-lg font-semibold capitalize text-primary-700 flex items-center">
              ...
              <span className="text-xs text-muted-foreground ml-2 font-normal">
                ...
                {rolePermissions.length === 1 ? "permission" : "permissions"})
              </span>
            </h3>
          </div>
          ...
          <div className="bg-secondary-50 p-3 rounded-t-md border border-secondary-200">
            <h3 className="text-lg font-semibold text-primary-700 flex items-center">
              ...
              <span className="text-xs text-muted-foreground ml-2 font-normal">
                ...
                {modulePermissions.length === 1 ? "role" : "roles"})
              </span>
            </h3>
          </div>
                ...
                {modulePermissions.map((permission) => (
                  ...
                  >
                    <td className="py-3 px-4 capitalize">
                      {formatRoleName(permission.role)}
                    </td>
                    <td className="py-3 px-4 text-center">
                      <Checkbox
                        checked={permission.canView}
        ...
        <CardContent>
          ...
          <div className="flex flex-col md:flex-row justify-between mb-6 gap-4">
            <div className="flex flex-col sm:flex-row gap-4">
              <Select
                value={filterRole || "all_roles"}
                onValueChange={(value) =>
                  setFilterRole(value === "all_roles" ? null : value)
                }
              >
              ...
              <Select
                value={filterModule || "all_modules"}
                onValueChange={(value) =>
                  setFilterModule(value === "all_modules" ? null : value)
                }
              >
                <SelectTrigger className="w-full sm:w-[200px]">
