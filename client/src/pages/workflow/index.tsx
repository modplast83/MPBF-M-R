...
export default function WorkflowIndex() {
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div
        className={`flex ${isMobile ? "flex-col space-y-3" : "justify-between items-center"} mb-4 md:mb-6`}
      >
      ...
      <Card className="overflow-hidden">
        ...
        <CardContent className="p-2 sm:p-6 pt-[21px] pb-[21px]">
          ...
          >
            ...
            <TabsList className="h-10 items-center justify-center rounded-md text-muted-foreground w-full flex mb-4 md:mb-6 p-0.5 gap-0.5 md:gap-1 bg-muted overflow-hidden pt-[31.25px] pb-[31.25px]">
              {showExtrusionTab && (
                <TabsTrigger
                  value="extrusion"
                  className="flex-1 flex flex-col md:flex-row items-center justify-center md:gap-1.5 py-1.5 md:py-2 px-0.5 md:px-2"
                >
                  <span className="material-icons text-primary-500 md:text-lg text-[17px] font-bold">
                    merge_type
                  </span>
              ...
              {showPrintingTab && (
                <TabsTrigger
                  ...
                  className="flex-1 flex flex-col md:flex-row items-center justify-center md:gap-1.5 py-1.5 md:py-2 px-0.5 md:px-2"
                >
                  <span className="material-icons text-warning-500 text-sm md:text-lg">
                    format_color_fill
                  </span>
                  <span className="text-xs md:text-sm hidden md:inline">
                    {t("rolls.printing")}
              ...
              {showCuttingTab && (
                <TabsTrigger
                  ...
                  className="flex-1 flex flex-col md:flex-row items-center justify-center md:gap-1.5 py-1.5 md:py-2 px-0.5 md:px-2"
                >
                  <span className="material-icons text-success text-sm md:text-lg">
                    content_cut
                  </span>
                  <span className="text-xs md:text-sm hidden md:inline">
                    {t("rolls.cutting")}
              ...
              <TabsContent value="extrusion" className="space-y-4">
                <div className="bg-secondary-50 rounded-lg p-3 md:p-4">
                  ...
                  <div className="mt-4 md:mt-6">
                    <h5 className="font-medium text-sm md:text-base mb-3">
