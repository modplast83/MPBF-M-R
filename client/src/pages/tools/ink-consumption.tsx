...
export default function InkConsumptionCalculator() {
  ...
  const calculateInkConsumption = (data: InkConsumptionFormData) => {
    ...
    const inkConsumptionPerUnit =
      printArea * coveragePercentage * inkVolumePerSquareCm;
      ...
      <Tabs defaultValue="calculator">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              ...
              <CardContent>
                <Form {...form}>
                  <form
                    onSubmit={form.handleSubmit(calculateInkConsumption)}
                    className="space-y-4"
                  >
                    <FormField
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Ink Coverage: {field.value}%</FormLabel>
                          <FormControl>
                            <Slider
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Percentage of ink transferred from anilox to
                            substrate
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-3 bg-muted rounded-md">
                      <p className="text-sm font-medium">
                        ...
                        <span className="font-bold">
                          {(results.totalInkWeight / 1000).toFixed(2)} kg
                        </span>
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span>
                            {(
                              (parseFloat(form.getValues("printArea")) / 100) *
                              (parseFloat(
                                form.getValues("coveragePercentage"),
                              ) /
                                100)
                            ).toFixed(2)}{" "}
                            cm²
                        ...
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">
                            Effective Anilox Vol:
                          </span>
                          <span>
                            {results.effectiveAniloxVolume.toFixed(2)} BCM
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">
                    ...
                    <div className="mt-4 text-sm text-muted-foreground">
                      <p>
                        <strong>Note:</strong> This calculation is an
                        approximation and actual ink consumption may vary based
                        on printing conditions, press setup, ink viscosity, and
                        other factors.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-center h-64 text-center">
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Enter print specifications and click "Calculate Ink
        ...
        <TabsContent value="guide">
          <Card>
            <CardHeader>
              <CardTitle>
                Guide to Using the Ink Consumption Calculator
              </CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-3 mt-2">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      The width and length of the printed area on each unit. The
                      calculator automatically computes the total area in square
                      millimeters.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      The percentage of the total print area that is covered
                      with ink. For example:
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Measured in BCM (Billion Cubic Microns), this represents
                      the volume of ink that the anilox roll can hold per square
                      inch. Typical values range from 2.0 to 14.0 BCM, depending
                      on the line screen and cell depth.
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      The percentage of ink that transfers from the anilox roll
                      to the substrate. This varies based on press conditions,
                      ink rheology, and substrate characteristics. Typical
              ...
              <div>
                ...
                <div className="space-y-3 mt-2">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      The volume of ink required to print a single unit,
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      The total volume of ink required for the entire print run,
                      shown in cm³ or liters (L).
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      The weight of ink required, calculated by multiplying the
                      volume by the ink density. This is typically more useful
                      for ordering and inventory purposes.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-1 mt-2">
                  <li>
                    Add 15-20% extra for wash-up, ink left in containers, and
                    wastage.
                  </li>
                  <li>
                    For multi-color jobs, calculate each color separately and
                    sum them.
                  </li>
                  <li>
                    The calculator does not account for make-ready waste or
                    press setup.
                  </li>
                  <li>
                    Results should be validated against historical consumption
                    data when possible.
                  </li>
                </ul>
              </div>
