...
export function FormTooltip({
  ...
  const arrowPositionClasses = {
    ...
    bottom:
      "bottom-full left-1/2 transform -translate-x-1/2 border-b-gray-800 border-l-transparent border-r-transparent",
    left: "left-full top-1/2 transform -translate-y-1/2 border-l-gray-800 border-t-transparent border-b-transparent",
    right:
      "right-full top-1/2 transform -translate-y-1/2 border-r-gray-800 border-t-transparent border-b-transparent",
  };
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            className={cn("absolute z-50 max-w-xs", positionClasses[position])}
