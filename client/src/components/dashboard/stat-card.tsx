      ...
      >
        ...
        >
          ...
          >
            ...
            <div className={cn("rounded-md p-2 shadow-sm", iconBgColor)}>
              <span className={cn("material-icons text-sm", iconColor)}>
                {icon}
              </span>
            </div>
          </div>
          ...
          <h3 className="text-2xl sm:text-3xl font-extrabold mt-2 sm:mt-3 text-gray-800 group-hover:text-primary-700 transition-colors">
            {value}
          </h3>
