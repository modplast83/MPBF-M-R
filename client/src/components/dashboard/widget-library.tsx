...
const WIDGET_TEMPLATES: WidgetTemplate[] = [
  ...
  // System Widgets
  {
    ...
    defaultConfig: {
      title: "Quick Actions",
      actions: ["new-order", "quality-check"],
    },
    configurable: true,
  },
  {
                        ...
                        >
                          <CardHeader className="pb-2">
                            <div className="flex items-center justify-between">
                              ...
                              <Badge
                                className={getCategoryColor(widget.category)}
                              >
                                {widget.category}
                              </Badge>
                            </div>
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      ...
                      <Input
                        ...
                        value={
                          widgetConfig.title ||
                          selectedWidget.defaultConfig.title
                        }
                        onChange={(e) =>
                          setWidgetConfig({
                            ...widgetConfig,
                    ...
                    {selectedWidget.type === "recent-orders" && (
                      <div>
                        ...
                        <Input
                          ...
                          value={
                            widgetConfig.limit ||
                            selectedWidget.defaultConfig.limit
                          }
                          onChange={(e) =>
                            setWidgetConfig({
                              ...widgetConfig,
                    ...
                    {selectedWidget.type === "production-chart" && (
                      <div>
                        ...
                        <select
                          ...
                          value={
                            widgetConfig.period ||
                            selectedWidget.defaultConfig.period
                          }
                          onChange={(e) =>
                            setWidgetConfig({
                              ...widgetConfig,
