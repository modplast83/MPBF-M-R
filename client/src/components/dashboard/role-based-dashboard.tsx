...
export function RoleBasedDashboard() {
  ...
  const availableTabs = isAdmin
    ? ROLE_BASED_VIEWS.administrator
    : ROLE_BASED_VIEWS.default;
  ...
  const handlePresetChange = (value: string) => {
    ...
    toast({
      ...
      description: t("dashboard.preset_changed_description", {
        preset: DASHBOARD_PRESETS[value as keyof typeof DASHBOARD_PRESETS],
      }),
    });
      ...
      >
        ...
        <div className="mb-4 lg:mb-6">
          ...
          >
            {availableTabs.includes("overview") && (
              <TabsTrigger
                value="overview"
                className="flex items-center justify-center gap-1 p-2 sm:p-3"
              >
        ...
        <TabsContent value="overview" className="mt-0 space-y-4 lg:space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-4 lg:gap-6">
            ...
            <div
              className={`col-span-1 ${selectedPreset === "balanced" ? "lg:col-span-6" : "lg:col-span-12"}`}
            >
              <PerformanceHealth />
            </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="border rounded-lg p-3 text-center">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {t("dashboard.resolved_violations")}
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="border rounded-md p-3 text-sm">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-1.5 gap-1">
                        <div className="font-medium flex-1 min-w-0">
                          Roll EX-0023-003 Thickness Check
                        </div>
                        <div className="px-2 py-0.5 bg-green-100 text-green-800 rounded text-xs flex-shrink-0 w-fit">
                          Pass
                        </div>
                      </div>
                      <div className="text-xs text-muted-foreground">
                    ...
                    <div className="border rounded-md p-3 text-sm">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-1.5 gap-1">
                        <div className="font-medium flex-1 min-w-0">
                          Roll EX-0022-001 Print Alignment
                        </div>
                        <div className="px-2 py-0.5 bg-red-100 text-red-800 rounded text-xs flex-shrink-0 w-fit">
                          Fail
                        </div>
                      </div>
                      <div className="text-xs text-muted-foreground">
                    ...
                    <div className="border rounded-md p-3 text-sm">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-1.5 gap-1">
                        <div className="font-medium flex-1 min-w-0">
                          Roll EX-0022-002 Color Verification
                        </div>
                        <div className="px-2 py-0.5 bg-green-100 text-green-800 rounded text-xs flex-shrink-0 w-fit">
                          Pass
                        </div>
