...
export default function CostCalculator() {
  ...
  // Material prices
  const [hdpePrice, setHdpePrice] = useState<number>(4.2);
  const [lldpePrice, setLldpePrice] = useState<number>(4.8);
  const [fillerPrice, setFillerPrice] = useState<number>(0.8);
  ...
  const [calculationResult, setCalculationResult] =
    useState<CostCalculationResult | null>(null);
  ...
  const calculateCost = (quantity: number) => {
    ...
    const wasteCostPerKg =
      (hdpeCost + lldpeCost + fillerCost + masterBatchCost) / quantity;
    ...
    const totalMaterialCost =
      hdpeCost + lldpeCost + fillerCost + masterBatchCost;
            ...
            <div className="space-y-4">
              <div>
                ...
                >
                  <SelectTrigger id="job-order">
                    <SelectValue
                      placeholder={t("cost_calculator.select_job_order")}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    {jobOrders &&
              ...
              <div className="border-t pt-4">
                <h3 className="font-medium mb-2">
                  {t("cost_calculator.manual_calculation")}
                </h3>
                <div className="flex items-end gap-2">
                  <div className="flex-1">
                    <Label htmlFor="manual-quantity">
                      {t("cost_calculator.quantity")}
                    </Label>
                    <Input
                      id="manual-quantity"
                      type="number"
                  ...
                  <Button variant="outline" onClick={calculateManualCost}>
              ...
              <div className="border-t pt-4">
                <h3 className="font-medium mb-2">
                  {t("cost_calculator.parameters")}
                </h3>

                <div className="space-y-3">
                  <div>
                    <Label htmlFor="waste-percentage">
                      {t("cost_calculator.waste_percentage")} (%)
                    </Label>
                    <Input
                      id="waste-percentage"
                      type="number"
                      ...
                      onChange={(e) =>
                        setWastePercentage(parseFloat(e.target.value))
                      }
                      min="0"
                      max="100"
                    />
                  ...
                  <div>
                    <Label htmlFor="fixed-cost">
                      {t("cost_calculator.fixed_cost_per_kg")} (SAR)
                    </Label>
                    <Input
                      id="fixed-cost"
                      type="number"
                      ...
                      onChange={(e) =>
                        setFixedCostPerKg(parseFloat(e.target.value))
                      }
                      min="0"
                      step="0.01"
                    />
              ...
              <div className="border-t pt-4">
                <h3 className="font-medium mb-2">
                  {t("cost_calculator.material_prices")} (SAR/kg)
                </h3>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={lldpePrice}
                      onChange={(e) =>
                        setLldpePrice(parseFloat(e.target.value))
                      }
                      min="0"
                      step="0.01"
                    />
                  ...
                  <div>
                    <Label htmlFor="filler-price">
                      {t("cost_calculator.filler")}
                    </Label>
                    <Input
                      id="filler-price"
                      type="number"
                      value={fillerPrice}
                      onChange={(e) =>
                        setFillerPrice(parseFloat(e.target.value))
                      }
                      min="0"
                      step="0.01"
                    />
                  ...
                  <div>
                    <Label htmlFor="mb-price">
                      {t("cost_calculator.masterbatch")}
                    </Label>
                    <Input
                      id="mb-price"
                      type="number"
                      ...
                      onChange={(e) =>
                        setMasterBatchPrice(parseFloat(e.target.value))
                      }
                      min="0"
                      step="0.01"
                    />
              ...
              <div className="border-t pt-4">
                <h3 className="font-medium mb-2">
                  {t("cost_calculator.material_percentages")} (%)
                </h3>
                <div
                  className={`text-xs mb-2 ${Math.abs(totalPercentage - 100) > 0.1 ? "text-red-500" : "text-green-500"}`}
                >
                  {t("cost_calculator.total")}: {totalPercentage}%
                  {Math.abs(totalPercentage - 100) > 0.1
                    ? ` (${t("cost_calculator.should_be")} 100%)`
                    : ""}
                </div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setHdpePercentage(parseFloat(e.target.value))
                      }
                      min="0"
                      max="100"
                    />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setLldpePercentage(parseFloat(e.target.value))
                      }
                      min="0"
                      max="100"
                    />
                  ...
                  <div>
                    <Label htmlFor="filler-percentage">
                      {t("cost_calculator.filler")}
                    </Label>
                    <Input
                      ...
                      onChange={(e) =>
                        setFillerPercentage(parseFloat(e.target.value))
                      }
                      min="0"
                      max="100"
                    />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setMasterBatchPercentage(parseFloat(e.target.value))
                      }
                      min="0"
                      max="100"
                    />
          ...
          <Card className="md:col-span-2">
            <CardHeader className="flex flex-row items-start justify-between">
              <div>
                ...
                <CardDescription>
                  {t("cost_calculator.calculation_description")}
                </CardDescription>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div className="bg-muted p-3 rounded-lg">
                  <div className="text-2xl font-bold">
                    {calculationResult.orderQuantity} kg
                  </div>
                ...
                <div className="bg-muted p-3 rounded-lg">
                  <div className="text-2xl font-bold">
                    {calculationResult.wastePercentage}%
                  </div>
                  <p className="text-sm text-muted-foreground">
                    {t("cost_calculator.waste")}
                  </p>
                </div>
                <div className="bg-muted p-3 rounded-lg">
                  <div className="text-2xl font-bold">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t("cost_calculator.total_quantity")}
                  </p>
                </div>
                <div className="bg-muted p-3 rounded-lg">
                  <div className="text-2xl font-bold">
                    SAR {formatNumberToLocale(calculationResult.fixedCostPerKg)}
                  </div>
                  <p className="text-sm text-muted-foreground">
                    {t("cost_calculator.fixed_cost")}
                  </p>
                </div>
              </div>
              ...
              <div className="border-t pt-4">
                <div>
                  <h3 className="text-lg font-medium mb-3">
                    {t("cost_calculator.material_costs")}
                  </h3>
                      ...
                      <thead>
                        <tr className="bg-muted">
                          ...
                          <th className="border p-2 text-right">
                            {t("cost_calculator.price")} (SAR/kg)
                          </th>
                          <th className="border p-2 text-right">
                            {t("common.percentage")}
                          </th>
                          <th className="border p-2 text-right">
                            {t("common.quantity")} (kg)
                          </th>
                          <th className="border p-2 text-right">
                            {t("cost_calculator.cost")} (SAR)
                          </th>
                        </tr>
                      </thead>
                      <tbody>
                        {calculationResult.materials.map((material, index) => (
                          <tr key={index} className="even:bg-muted/50">
                            ...
                            <td className="border p-2 text-right">
                              {formatNumberToLocale(material.pricePerKg)}
                            </td>
                            <td className="border p-2 text-right">
                              {material.percentage}%
                            </td>
                            ...
                            <td className="border p-2 text-right">
                              {formatNumberToLocale(material.cost, 0)}
                            </td>
                          </tr>
                        ))}
                        <tr className="bg-muted font-medium">
                          <td className="border p-2" colSpan={3}>
                            {t("cost_calculator.total_material_cost")}
                          </td>
                          <td className="border p-2 text-right">
                            {calculationResult.orderQuantity}
                          </td>
                          <td className="border p-2 text-right">
                            {formatNumberToLocale(
                              calculationResult.totalMaterialCost,
                              0,
                            )}
                          </td>
                        </tr>
                        <tr>
                          <td className="border p-2" colSpan={3}>
                            {t("cost_calculator.waste_cost")}
                          </td>
                          <td className="border p-2 text-right">
                            {Math.round(
                              calculationResult.orderQuantity *
                                (calculationResult.wastePercentage / 100),
                            )}
                          </td>
                          <td className="border p-2 text-right">
                            {formatNumberToLocale(
                              calculationResult.wasteCost,
                              0,
                            )}
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td className="border p-2 text-right">
                            {formatNumberToLocale(
                              calculationResult.totalFixedCost,
                              0,
                            )}
                          </td>
                        </tr>
                        ...
                        <tr className="bg-primary/10 font-bold">
                          <td className="border p-2" colSpan={3}>
                            {t("cost_calculator.cost_per_kg")}
                          </td>
                          <td className="border p-2 text-right"></td>
                          <td className="border p-2 text-right">
                            {formatNumberToLocale(calculationResult.costPerKg)}
                          </td>
                        </tr>
                      </tbody>
                    </table>
