...
export function AbaMaterialsDnd({
  ...
  >([]);
  const [screwAMaterials, setScrewAMaterials] = useState<
    MaterialDistribution[]
  >([]);
  const [screwBMaterials, setScrewBMaterials] = useState<
    MaterialDistribution[]
  >([]);
  ...
  useEffect(() => {
    if (rawMaterials.length > 0) {
      ...
      if (initialDistributions && initialDistributions.length > 0) {
        ...
        const assignedMaterialIds = initialDistributions.map(
          (d) => d.materialId,
        );
  ...
  const handleDragEnd = (result: DropResult) => {
    ...
    let setSourceList: React.Dispatch<
      React.SetStateAction<MaterialDistribution[]>
    >;
    let setDestList: React.Dispatch<
      React.SetStateAction<MaterialDistribution[]>
    >;
                    ...
                    {unassignedMaterials.length === 0 ? (
                      <div className="flex flex-col items-center justify-center h-full">
                        ...
                        <p className="text-gray-500 text-center">
                          {t(
                            "production.aba_calculator.no_available_materials",
                          )}
                        </p>
                      </div>
                    ) : (
                            ...
                            >
                              ...
                              <div className="pt-2">
                                ...
                                <Slider
                                  ...
                                  onValueChange={(value) =>
                                    handleScrewASliderChange(index, value)
                                  }
                                />
                              </div>
                            </div>
                            ...
                            >
                              ...
                              <div className="pt-2">
                                ...
                                <Slider
                                  ...
                                  className={`${isRTL ? "rtl-slider" : ""}`}
                                  onValueChange={(value) =>
                                    handleScrewBSliderChange(index, value)
                                  }
                                />
                              </div>
                            </div>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center text-gray-500 text-sm">
                  <span className="material-icons text-primary-500 text-base mr-1">
                    help_outline
                  </span>
