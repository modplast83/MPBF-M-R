...
export function ProgressTracker({
  ...
  const checkMilestones = (current: ProgressStats, previous: ProgressStats) => {
    ...
    if (
      current.completedToday >= current.totalScheduled &&
      current.totalScheduled > 0
    ) {
      onMilestoneReached?.("perfect_score", {
        title: "Perfect Day!",
        subtitle: "All Tasks Completed",
        description:
          "Outstanding work! You've completed all scheduled maintenance tasks.",
        stats: [
        ...
        <CardContent>
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <span>
                {stats.completedToday} of {stats.totalScheduled}
              </span>
              <motion.span
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm">
              ...
              <motion.span
                ...
                initial={{
                  scale: stats.overdue > previousStats.overdue ? 1.3 : 1,
                }}
                animate={{ scale: 1 }}
                transition={{ duration: 0.3 }}
